...
function startGame() {
    ...
    helicopter = new component(40,30,"helicopter1.png",50,120,"image");
    score = new component("20px", "Helvetica", "yellow", 400, 50, "text");
    helicopterSound = new sound("helicopterSound.wav");
...
function updateGameArea() {
	...
	if(intervals(2)){
		helicopter.image.src = "helicopter2.png";
	}
	if(intervals(4)){
		helicopter.image.src = "helicopter3.png";
	}
	if(intervals(6)){
		helicopter.image.src = "helicopter1.png"
	}
	if(intervals(2)){
		minHeight = 10;
		maxHeight = 30;
